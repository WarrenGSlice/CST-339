...
public class HelloWorldController {
	...
	/**
	 * Simple Hello World Controller that returns a View Name along with a Model Attribute named message2.
	 ...
	 * @param model Model to bind to the View
	 * 
	 * @return View named hello
	 */
	@GetMapping("/test4")
	public String printHello(@RequestParam("message") String message, Model model) {
		// Simply return a Model attribute named message return a View named hello
